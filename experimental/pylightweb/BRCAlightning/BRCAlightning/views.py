...
def home(request):
    ...
    return render(request, 'BRCAlightning/index.html', {'query_around_form':query_around_form, 'query_between_form':query_between_form})

def help(request):
    """
        Display Questions
    """
    return render(request, 'BRCAlightning/help.html')
