...
class GenomeStatistic(models.Model):
    ...
    avg_annotations_per_position = models.DecimalField(null=True, max_digits=15, decimal_places=3)
    max_annotations_per_position = models.PositiveIntegerField(null=True)
    avg_annotations_per_tile = models.DecimalField(null=True, max_digits=15, decimal_places=3)
    max_annotations_per_tile = models.PositiveIntegerField(null=True)
    def __unicode__(self):
