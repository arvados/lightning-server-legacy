...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tile_library', '0013_auto_20141104_1715'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='tile_variants',
            field=models.ManyToManyField(related_name=b'genome_variants', through='tile_library.Translation', to='tile_library.TileVariant', db_index=True),
